...
export class FormC1Component implements OnInit {
  ...
  onClickImageSample(){
    this.c1Data.data.parameterValues['DE:Image for desktop - 960 x 410'] = 'https://images.americanhotel.com/images/banners/8962k_Westpoint_A1_100919-960.jpg?123';
    this.c1Data.data.parameterValues['DE:Image for mobile - 480 x 205'] = 'https://images.americanhotel.com/images/banners/8962k_Westpoint_A1_100919-480.jpg?123';
  }
