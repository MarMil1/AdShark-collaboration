...
export class FormC1Component implements OnInit {
  ...
  onClickImageSample(){
    this.c1Data.data.parameterValues['DE:Image for desktop - 960px x 410px'] = 'https://images.americanhotel.com/images/banners/8962k_Westpoint_C1_100919-960.jpg?123';
    this.c1Data.data.parameterValues['DE:Image for mobile - 480px x 205px'] = 'https://images.americanhotel.com/images/banners/8962k_Westpoint_C1_100919-480.jpg?123';
  }
