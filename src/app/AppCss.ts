export class AppCss {
  ...
  getA1CSS() {
    this.css =
      ...
      .a1-hero .col-lg-8,     .a1-hero .col-md-12 {
        padding-left: 0;
        padding-right: 0;
      }
      ...
      .a1-hero_primary p.sub-headline,     .a1-hero_primary h2.headline,     .a1-hero_primary a.hero-link:hover span {
        color: #000;
      }
      
      .a1-hero_secondary p.sub-headline,     .a1-hero_secondary h2.headline,     .a1-hero_secondary a.hero-link:hover span {
        color: #FFF;
      }
      
      .a1-hero_primary a:hover span.cta,     .a1-hero_secondary a:hover span.cta {
        text-decoration: underline;
      }
      
      .a1-hero_primary a span.cta,     .a1-hero_secondary a span.cta {
      ...
      .c-hero.a1-hero_image {
        height: 410px;
      }     /********* QUERIES ********/@media (max-width: 1370px) {
        .a1-hero .c-hero__copy {
          max-width: 96%;
        }
