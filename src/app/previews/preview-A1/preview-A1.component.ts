...
export class PreviewA1Component implements IA1Iframe, DoCheck {
  ...
  generateCode() {
    ...
    try {
      ...
      must target and update .A1-iframe class and look for #A1logo id */
      if (this.a1Data.data.parameterValues['DE:Logo position'] === 'Top') {
        ...
        $('.A1-iframe').contents().find('#A1logo').addClass('l-p-top').removeClass('l-p-bottom');
        ...
        $('.A1-iframe').contents().find('#A1logo').addClass('l-p-bottom').removeClass('l-p-top');
      }
