...
export class PreviewC1Component implements IC1Iframe, DoCheck {
  ...
  generateCode() {
    ...
    try {
      ...
      /* To change logo position in preview from top to bottom
      must target and update .C1-iframe class and look for #C1logo id */
      if (this.c1Data.data.parameterValues['DE:Logo position'] === 'Top') {
        console.log('logo position set to top');
        // document.querySelector('.a1-supplier-logo img').classList.add('l-p-top');
        // document.querySelector('.a1-supplier-logo img').classList.remove('l-p-bottom');
        $('.C1-iframe').contents().find('#C1logo').addClass('l-p-top').removeClass('l-p-bottom');

      } else if (this.c1Data.data.parameterValues['DE:Logo position'] === 'Bottom') {
        console.log('logo position set to bottom');
        // document.querySelector('.a1-supplier-logo img').classList.add('l-p-bottom');
        // document.querySelector('.a1-supplier-logo img').classList.remove('l-p-top');
        $('.C1-iframe').contents().find('#C1logo').addClass('l-p-bottom').removeClass('l-p-top');
      }
